...
// Apply the adapter to the spinner
        ...
        choose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityCompat.requestPermissions(addfeeds.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},CODE_GALLERY_REQUEST);
            }
        });
        upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                progressbar=new ProgressDialog(addfeeds.this);
                ...
                MySingleton.getInstance(addfeeds .this).addToRequestQueue(stringRequest);
                Intent i=new Intent(addfeeds.this,home.class);
                startActivity(i);
            }
        });
    }
