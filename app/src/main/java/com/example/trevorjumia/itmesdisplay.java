...
public class itmesdisplay extends Activity implements NavigationView.OnNavigationItemSelectedListener {
    // Log tag
    ...
    String url3 = "http://192.168.60.188/www/html/trevor/getpictures.php";
...
//        }, 10000);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        Intent k=getIntent();
        String name=k.getStringExtra("name");
        String email1=k.getStringExtra("email");
        String prevelage=k.getStringExtra("prevelage");
        String phone1=k.getStringExtra("phone");
        switch (menuItem.getItemId()){

            case R.id.cabbages:
                Intent i=new Intent(itmesdisplay.this,itmesdisplay.class);
                i.putExtra("category","cabbages");


               i.putExtra("name",name);
               i.putExtra("email",email1);
                i.putExtra("prevelage",prevelage);

                i.putExtra("phone",phone1);
                startActivity(i);
                break;
            case R.id.onions:
                Intent i2=new Intent(itmesdisplay.this,itmesdisplay.class);
                i2.putExtra("category","onions");


                i2.putExtra("name",name);
                i2.putExtra("email",email1);
                i2.putExtra("prevelage",prevelage);

                i2.putExtra("phone",phone1);
                startActivity(i2);
                break;
            case R.id.maize:
                Intent i3=new Intent(itmesdisplay.this,itmesdisplay.class);
                i3.putExtra("category","maize");


                i3.putExtra("name",name);
                i3.putExtra("email",email1);
                i3.putExtra("prevelage",prevelage);

                i3.putExtra("phone",phone1);
                startActivity(i3);
                break;
            case R.id.beans:
                Intent i4=new Intent(itmesdisplay.this,itmesdisplay.class);
                i4.putExtra("category","beans");


                i4.putExtra("name",name);
                i4.putExtra("email",email1);
                i4.putExtra("prevelage",prevelage);

                i4.putExtra("phone",phone1);
                startActivity(i4);
                break;
            case R.id.potatoes:
                Intent i8=new Intent(itmesdisplay.this,itmesdisplay.class);
                i8.putExtra("category","potatoes");


                i8.putExtra("name",name);
                i8.putExtra("email",email1);
                i8.putExtra("prevelage",prevelage);

                i8.putExtra("phone",phone1);
                startActivity(i8);
                break;


            case R.id.home:
                Intent i7=new Intent(itmesdisplay.this,home.class);
               // i7.putExtra("category","category");
                startActivity(i7);
                break;

            case R.id.logout:
                Intent i9=new Intent(itmesdisplay.this,MainActivity.class);
             //   i9.putExtra("category","category");
                startActivity(i9);
                break;
